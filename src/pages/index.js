  ...
  return (
    <Layout location={location} title={siteTitle} onlyMobile="onlyMobile">
      ...
      <ol style={{ listStyle: `none` }} className="home-posts">
        ...
        <Link to={ "mailto:" + config.authorMail + "?subject=Ask%20for%20WAV:" } style={{ color: 'black', textDecoration: 'underline', position: 'relative', zIndex: 2, top: '20px' }}>{config.askWavTitle}</Link>
      </ol>
      </>
    </Layout>
  )
